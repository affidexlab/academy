...
export default function AcademyAbout() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
      ...
      {/* ══ HERO ════════════════════════════════════════════════════ */}
      <section className="relative overflow-hidden noise-overlay py-16 md:py-28"
        ...
        <div className="container">
          <div className="grid gap-6 md:grid-cols-2 max-w-[860px]">
            {[
              ...
              <div key={i} className="rounded-2xl border p-6 md:p-8" style={{ borderColor: "var(--border)", background: "var(--cream)" }}>
      ...
      <section className="py-12 md:py-24" style={{ background: "var(--cream)", borderBottom: "1px solid var(--border)" }}>
        <div className="container flex flex-col gap-10">
          ...
          <h2 className="mb-10 md:mb-16 max-w-lg" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(2rem,3.5vw,3rem)", fontWeight: 700, lineHeight: 1.15, color: "var(--navy)" }}>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 max-w-[1000px]">
            {values.map((v, i) => (
              <div key={i} className="card rounded-2xl border bg-white p-5 md:p-7" style={{ borderColor: "var(--border)" }}>
                <div className="mb-4 md:mb-5 inline-flex rounded-2xl p-3 md:p-3.5" style={{ background: "rgba(11,28,46,0.06)" }}>
      ...
      <section className="py-12 md:py-24" style={{ background: "#FFFFFF", borderBottom: "1px solid var(--border)" }}>
        <div className="container flex flex-col gap-10">
          ...
          <div className="grid gap-5 sm:grid-cols-2 max-w-[860px]">
            {regs.map((r, i) => (
              <div key={i} className="rounded-2xl border p-5 md:p-7" style={{ borderColor: "var(--border)", background: "var(--cream)" }}>
                <h3 className="label mb-4 md:mb-5" style={{ color: "var(--gold)" }}>{r.cat}</h3>
      ...
      <section className="py-12 md:py-24" style={{ background: "#FFFFFF", borderBottom: "1px solid var(--border)" }}>
        <div className="container flex flex-col gap-10">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4 max-w-[1000px]">
            {[
              { photo: CEO_PHOTO, initials: "UES", name: "Mr. Utibe-Abasi Emmanuel Samuel, FIPPN", role: "Chairman & CEO", bio: "Founder and Chief Executive. Technology entrepreneur and vocational education advocate based in Uyo. Drove the institution from incorporation to internationally affiliated standing." },
      ...
      <section className="py-12 md:py-24" style={{ background: "#FFFFFF", borderBottom: "1px solid var(--border)" }}>
        <div className="container">
          <div className="grid gap-8 md:gap-12 md:grid-cols-2 max-w-[860px]">
            <div className="flex flex-col gap-6">
              <div className="label mb-5">Our Training Centres</div>
              <h2 className="mb-6 md:mb-8" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(1.8rem,3vw,2.5rem)", fontWeight: 700, lineHeight: 1.2, color: "var(--navy)" }}>
