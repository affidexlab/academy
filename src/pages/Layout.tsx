        ...
        <div className="grid gap-12 lg:grid-cols-[2fr_1fr_1fr_1.4fr]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="mt-4 flex items-center gap-3">
              <a href="https://web.facebook.com/affidexacademy/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
              ...
              <a href="https://www.instagram.com/affidexacademy/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white transition-colors">
